...
export default function Footer() {
  return (
    <footer className="border-t-1 border-quaternary pt-8 md:py-10">
      ...
      <p className="text-[10px] text-center text-quaternary font-medium mt-10 sm:text-left">01001001 00100000 01100001 01110000 01110000 01110010 01100101 01100011 01101001 01100001 01110100 01100101 00100000 01110100 01101000 01100101 00100000 01100101 01100110 01100110 01101111 01110010 01110100</p>
    </footer>
  );
}