...
At this stage, the most important concepts to understand are:
...
* Kafka clusters distribute partitions across brokers
* Leaders serve traffic
* Followers provide fault tolerance

The next logical step is understanding:
...
Those concepts explain how Kafka manages distributed coordination internally.
